    ...
    <section className="relative w-full py-20 md:py-28 bg-[#F8FAFC] overflow-hidden select-none">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-12 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#0F172A] uppercase">
            ...
            {testimonialsData.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`absolute w-[90%] sm:w-[490px] h-[285px] p-6 sm:p-7 rounded-2xl sm:rounded-3xl border overflow-hidden flex flex-col justify-between transition-shadow duration-300 ${
                    isCenter
                ...
                >
                  ...
                  <div
                    className={`absolute -bottom-8 -right-8 w-44 h-44 rounded-full blur-2xl pointer-events-none transition-opacity duration-700 ${
                      isCenter
                  ...
                  <div className="relative z-10 flex flex-col justify-between h-full">
                    ...
                    <p
                      className={`leading-relaxed tracking-normal font-normal ${
                        isCenter
                    ...
                    <div
                      className={`flex items-center gap-3 pt-3.5 border-t ${
                        isCenter ? 'border-slate-100/90' : 'border-slate-200/40'
                      }`}
                    >
                      <img
                        src={item.image}
                      ...
                      <div className="text-left">
                        <h4
                          className={`font-bold leading-tight ${
                            isCenter ? 'text-sm sm:text-base text-[#0F172A]' : 'text-xs text-slate-700 font-semibold'
                          }`}
                        >
                          {item.name}
                        </h4>
                        <p
                          className={`text-slate-500 font-medium leading-tight mt-0.5 truncate max-w-[240px] ${
                            isCenter ? 'text-xs' : 'text-[11px] text-slate-400'
                          }`}
                        >
                          {item.role}
                        </p>
        ...
        <div className="mt-12 md:mt-16 pt-8 border-t border-slate-200/60 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 text-center">
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-[#4A72E8] via-indigo-600 to-[#6366F1] shadow-[0_6px_18px_rgba(74,114,232,0.28)] hover:shadow-[0_10px_24px_rgba(74,114,232,0.38)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
          >
